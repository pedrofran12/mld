...
from .mld1.mld_globals import MULTICAST_LISTENER_QUERY_TYPE, MULTICAST_LISTENER_DONE_TYPE,\
    MULTICAST_LISTENER_REPORT_TYPE
...
class InterfaceMLD(Interface):
    ...
    def __init__(self, interface_name: str, vif_index: int = 0):
        ...
        if not netifaces.AF_INET6 in if_addr_dict:
            raise Exception("Adding MLD interface failed because %s does not "
        ...
        from .mld1.RouterState import RouterState
