...
class GroupState(object):
    LOGGER = logging.getLogger('mld.mldv1.RouterState.GroupState')
    ...
    def set_timer(self, alternative: bool = False, max_response_time: int = None):
        ...
        self.clear_timer()
        if not alternative:
            time = mld_globals.MULTICAST_LISTENER_INTERVAL
        else:
    ...
    def set_retransmit_timer(self):
        ...
        retransmit_timer = Timer(mld_globals.LAST_LISTENER_QUERY_INTERVAL, self.retransmit_timeout)
